        ...
        <form method="post" action="{{ route('LaravelInstaller::licenseCheck') }}" class="tabs-wrap">
            ...
            <div>
                <div class="form-group {{ $errors->has('email') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="email" id="email" value="" placeholder="Enter random Mail Address" />
                ...
                <div class="form-group {{ $errors->has('username') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="username" id="username" value="" placeholder="Enter random value" />
