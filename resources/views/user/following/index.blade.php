...
@section('content')
    <div class="page-header">
        <h4 class="page-title">{{ $keywords['Following_List'] ?? __('Following List') }}</h4>
        <ul class="breadcrumbs">
            ...
            <li class="nav-item">
                <a href="#">{{ $keywords['Following_Page'] ?? __('Following Page') }}</a>
            </li>
            <li class="separator">
                <i class="flaticon-right-arrow"></i>
            </li>
            <li class="nav-item">
                <a href="#">{{ $keywords['Following'] ?? __('Following') }}</a>
            </li>
        </ul>
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="card-title d-inline-block">{{ $keywords['Following'] ?? __('Following') }}</div>
                        </div>
                        <div class="col-lg-3">
                        </div>
                            ...
                            @else
                                @if (count($users) == 0)
                                    <h3 class="text-center">
                                        {{ $keywords['NO_FOLLOWING_USER_FOUND'] ?? __('NO FOLLOWING USER FOUND') }}</h3>
                                @else
                                        ...
                                        <table class="table table-striped mt-3">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th scope="col">{{ $keywords['User_name'] ?? __('User name') }}
                                                    </th>
