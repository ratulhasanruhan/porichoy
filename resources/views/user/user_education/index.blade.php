...
@section('content')
    <div class="page-header">
        <h4 class="page-title">{{ $keywords['Educations'] ?? __('Educations') }}</h4>
        <ul class="breadcrumbs">
            ...
            <li class="nav-item">
                <a href="#">{{ $keywords['Educations_Page'] ?? __('Educations Page') }}</a>
            </li>
            <li class="separator">
                <i class="flaticon-right-arrow"></i>
            </li>
            <li class="nav-item">
                <a href="#">{{ $keywords['Educations'] ?? __('Educations') }}</a>
            </li>
        </ul>
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="card-title d-inline-block">{{ $keywords['Educations'] ?? __('Educations') }}</div>
                        </div>
                        <div class="col-lg-4 offset-lg-4 mt-2 mt-lg-0">
                            @if (!is_null($userDefaultLang))
                                <a href="#" class="btn btn-primary float-right btn-sm" data-toggle="modal"
                                    data-target="#createModal"><i class="fas fa-plus"></i>
                                    {{ $keywords['Add_Educations'] ?? __('Add Educations') }}</a>
                            ...
                            @else
                                @if (count($educations) == 0)
                                    <h3 class="text-center">
                                        {{ $keywords['NO_EDUCATION_FOUND'] ?? __('NO EDUCATION FOUND') }}</h3>
                                @else
                                        ...
                                        <table class="table table-striped mt-3" id="basic-datatables">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th scope="col">{{ $keywords['Degree_Name'] ?? __('Degree Name') }}
                                                    </th>
                                                    <th scope="col">{{ $keywords['Start_Date'] ?? __('Start Date') }}
                                                    </th>
                                                    <th scope="col">{{ $keywords['End_Date'] ?? __('End Date') }}</th>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">
                        {{ $keywords['Add_Educations'] ?? __(' Add Educations') }}</h5>
