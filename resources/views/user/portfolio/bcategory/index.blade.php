...
@section('content')
    <div class="page-header">
        <h4 class="page-title">{{ $keywords['Portfolio_Categories'] ?? __('Portfolio Categories') }}</h4>
                        ...
                        <div class="col-lg-4 offset-lg-1 mt-2 mt-lg-0">
                            @if (!is_null($userDefaultLang))
                                <a href="#" class="btn btn-primary float-right btn-sm" data-toggle="modal"
                                    ...
                                    {{ $keywords['Add_Portfolio_Category'] ?? __('Add Portfolio Category') }}</a>
                            ...
                            @else
                                @if (count($categories) == 0)
                                    <h3 class="text-center">
                                        {{ $keywords['NO_PORTFOLIO_CATEGORY_FOUND'] ?? __('NO PORTFOLIO CATEGORY FOUND') }}
                                    </h3>
                                @else
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">
                        {{ $keywords['Add_Portfolio_Category'] ?? __('Add Portfolio Category') }}</h5>
                    ...
                    <form id="ajaxForm" class="modal-form create" action="{{ route('user.portfolio.category.store') }}"
                        ...
                        <div class="form-group">
                            ...
                            <p class="text-warning">
                                <small>{{ $keywords['portfolio_category_Serial_Number_msg'] ?? __('The higher the serial number is, the later the portfolio category will be shown') }}.</small>
                            </p>
                        </div>
                    </form>
                </div>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">
                        {{ $keywords['Edit_Portfolio_Category'] ?? __('Edit Portfolio Category') }}</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
