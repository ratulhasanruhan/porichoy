...
@section('content')
    <div class="page-header">
        <h4 class="page-title">{{ $keywords['Logo'] ?? __('Logo') }}</h4>
        <ul class="breadcrumbs">
            ...
            <li class="nav-item">
                <a href="#">{{ $keywords['Logo'] ?? __('Logo') }}</a>
            </li>
        </ul>
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="card-title">{{ $keywords['Update_Logo'] ?? __('Update Logo') }}</div>
                </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <div class="col-12 mb-2">
                                                <label for="image"><strong> {{ $keywords['Logo'] ?? __('Logo') }}
                                                        **</strong></label>
                                            </div>
                                            ...
                                            @if ($errors->has('file'))
                                                <p id="errfile" class="mb-0 text-danger em">{{ $errors->first('file') }}
                                                </p>
                                            @endif
                                        </div>
                                    </div>
